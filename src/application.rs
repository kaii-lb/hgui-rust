...
use crate::HguiRustWindow;

mod imp {
    use super::*;

    #[derive(Debug, Default)]
    pub struct HguiRustApplication {}

    #[glib::object_subclass]
    impl ObjectSubclass for HguiRustApplication {
        const NAME: &'static str = "HguiRustApplication";
        type Type = super::HguiRustApplication;
    ...
    impl ApplicationImpl for HguiRustApplication {
        ...
        fn activate(&self) {
            ...
            let window = if let Some(window) = application.active_window() {
                ...
                let window = HguiRustWindow::new(&*application);
                window.upcast()
            };
    ...
    impl GtkApplicationImpl for HguiRustApplication {}
    impl AdwApplicationImpl for HguiRustApplication {}
}

glib::wrapper! {
    pub struct HguiRustApplication(ObjectSubclass<imp::HguiRustApplication>)
